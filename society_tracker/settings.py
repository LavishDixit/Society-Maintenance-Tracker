...
EMAIL_HOST_USER = config('EMAIL_HOST_USER', default='apikey')  # literal string 'apikey' for SendGrid
EMAIL_HOST_PASSWORD = config('SENDGRID_API_KEY', default='')
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@societytracker.local')
